...
# -*- coding: utf-8 -*-
"""
قاعدة البيانات الأولية لدلالات الحروف في نظام بصيرة

هذا الملف يحتوي على التمثيل الدلالي الأولي للحروف العربية والإنجليزية
بناءً على التفسيرات الرمزية التي قدمها باسل.

يتم استخدام هذه البيانات كأساس لوحدة SymbolicInterpretationEngine
لتفسير الكلمات والمفاهيم بناءً على دلالات الحروف المكونة لها.
"""
    ...
    "en": {  # الحروف الإنجليزية
        "A": {
            ...
            "visual_form_semantics": {
                "uppercase": ["قمة جبل", "برج", "رمز رأس الثور (Aleph)"],
                "lowercase": ["أذن تستمع", "ورقة شجر رقيقة", "حلقة (مثل القرط)", "خيمة أو مأوى"]
            },
            "core_semantic_axes": {
                "authority_tenderness": ("جلال/طموح/سلطة/إعجاب/روعة (للشكل الكبير)", "حنان/قرب/احتواء/دفء (للشكل الصغير)")
            },
            "general_connotations": [
                "Apex", "Ambition", "Authority", "Admiration", "Awesome",  # من دلالات الشكل الكبير
                "affection", "adore", "accompany", "arm", "at home"       # من دلالات الشكل الصغير
            ],
            "examples_from_basil": [],
        ...
        "B": {
            ...
            "visual_form_semantics": {
                "uppercase": ["عمود مستقيم مع بروزين", "جسم ممتلئ", "حامل"],
                "lowercase": ["بطن ممتلئة", "حمل", "احتواء"]
            },
            "core_semantic_axes": {
                "fullness_birth": ("امتلاء/ولادة/بداية/بناء", "فراغ/نهاية/هدم")
            },
            "general_connotations": [
                "Birth", "Begin", "Build", "Body", "Bulge",  # من دلالات الشكل الكبير
                "baby", "belly", "bear", "bulb", "bubble"    # من دلالات الشكل الصغير
            ],
            "examples_from_basil": [],
        ...
        "O": {
            ...
            "visual_form_semantics": {
                "uppercase": ["دائرة كاملة", "عين مفتوحة", "فم متعجب"],
                "lowercase": ["دائرة صغيرة", "نقطة", "بذرة"]
            },
            "core_semantic_axes": {
                "wholeness_emptiness": ("اكتمال/شمول/دائرية", "فراغ/خواء/انفتاح")
            },
            "general_connotations": [
                "Orb", "Omnipresent", "Overall", "Observe", "Open",  # من دلالات الشكل الكبير
                "origin", "orbit", "only", "omen", "odd"             # من دلالات الشكل الصغير
            ],
            "examples_from_basil": [],
        ...
        "E": {
            ...
            "visual_form_semantics": {
                "uppercase": ["رفوف متعددة", "سلم أفقي", "تقسيمات منظمة"],
                "lowercase": ["نصف دائرة صغيرة", "فتحة جزئية"]
            },
            "core_semantic_axes": {
                "extension_organization": ("امتداد/تنظيم/تقسيم", "تركيز/تجميع")
            },
            "general_connotations": [
                "Extend", "Equal", "Establish", "Enumerate", "Educate",  # من دلالات الشكل الكبير
                "edge", "emerge", "emit", "echo", "end"                  # من دلالات الشكل الصغير
            ],
            "examples_from_basil": [],
        ...
        "I": {
            ...
            "visual_form_semantics": {
                "uppercase": ["عمود مستقيم", "شخص واقف", "الذات المنفردة"],
                "lowercase": ["نقطة مع خط قصير", "شخص صغير", "ذات محدودة"]
            },
            "core_semantic_axes": {
                "identity_individuality": ("هوية/فردية/ذاتية", "جماعية/غيرية")
            },
            "general_connotations": [
                "Identity", "Individual", "Intense", "Immediate", "Inspire",  # من دلالات الشكل الكبير
                "intimate", "inner", "idea", "imagine", "illuminate"          # من دلالات الشكل الصغير
            ],
            "examples_from_basil": [],
        ...
        "N": {
            ...
            "visual_form_semantics": {
                "uppercase": ["جسر", "رابط بين عمودين", "حركة صعود وهبوط"],
                "lowercase": ["قوس صغير مع عمود", "حركة انحناء"]
            },
            "core_semantic_axes": {
                "connection_negation": ("ربط/اتصال/شبكة", "نفي/رفض/عكس")
            },
            "general_connotations": [
                "Network", "Navigate", "Nexus", "Negotiate", "Nurture",  # من دلالات الشكل الكبير
                "near", "node", "nest", "narrow", "no"                   # من دلالات الشكل الصغير
            ],
            "examples_from_basil": [],
        ...
        "M": {
            ...
            "visual_form_semantics": {
                "uppercase": ["جبال متعددة", "موجات", "ثديان"],
                "lowercase": ["قوسان متصلان", "موجة صغيرة"]
            },
            "core_semantic_axes": {
                "motherhood_magnitude": ("أمومة/عظمة/كثرة", "فردية/صغر")
            },
            "general_connotations": [
                "Mother", "Magnitude", "Multiple", "Mountain", "Massive",  # من دلالات الشكل الكبير
                "many", "more", "merge", "mutual", "mild"                  # من دلالات الشكل الصغير
            ],
            "examples_from_basil": [],
        ...
        "W": {
            ...
            "visual_form_semantics": {
                "uppercase": ["موجات متعددة", "وديان", "حركة متذبذبة"],
                "lowercase": ["موجات صغيرة", "تموجات متتالية"]
            },
            "core_semantic_axes": {
                "wave_wonder": ("تموج/تذبذب/حركة", "ثبات/استقرار")
            },
            "general_connotations": [
                "Wave", "Wonder", "Wander", "Water", "Wind",  # من دلالات الشكل الكبير
                "wiggle", "weave", "womb", "well", "way"      # من دلالات الشكل الصغير
            ],
            "examples_from_basil": [],
        ...
        "Y": {
            ...
            "visual_form_semantics": {
                "uppercase": ["طريق متفرع", "غصن شجرة", "خيارات متعددة"],
                "lowercase": ["خط منحني مع ذيل", "بذرة نابتة"]
            },
            "core_semantic_axes": {
                "choice_yearning": ("اختيار/تفرع/تساؤل", "حسم/تحديد")
            },
            "general_connotations": [
                "Yes", "Yield", "Yearning", "Youth", "Yoke",  # من دلالات الشكل الكبير
                "young", "yield", "yearn", "yawn", "yell"     # من دلالات الشكل الصغير
            ],
            "examples_from_basil": [],
        ...
        "Z": {
            ...
            "visual_form_semantics": {
                "uppercase": ["برق", "مسار متعرج", "سيف"],
                "lowercase": ["خط متعرج صغير", "حركة سريعة"]
            },
            "core_semantic_axes": {
                "speed_finality": ("سرعة/حدة/نهاية", "بطء/بداية")
            },
            "general_connotations": [
                "Zap", "Zigzag", "Zealous", "Zero", "Zenith",  # من دلالات الشكل الكبير
                "zip", "zoom", "zest", "zeal", "zone"          # من دلالات الشكل الصغير
            ],
            "examples_from_basil": [],
...
# دالة مساعدة لتسهيل الوصول لاحقاً في SemanticDatabase
def get_initial_letter_semantics_data() -> Dict[str, Dict[str, Dict[str, Any]]]:
    """
    تُرجع قاعدة البيانات الأولية لدلالات الحروف.
    
    Returns:
        Dict[str, Dict[str, Dict[str, Any]]]: قاموس متداخل يحتوي على دلالات الحروف
        مقسمة حسب اللغة والحرف.
    """
    return initial_letter_semantics_data
