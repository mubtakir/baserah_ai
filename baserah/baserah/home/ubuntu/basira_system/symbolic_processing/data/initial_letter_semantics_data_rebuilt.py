...
initial_letter_semantics_data = {
    "ar": {
        "ا": {
            ...
            "examples_from_basil": ['أ ل م (في سورة البقرة): الألف للعظمة والتعظيم.'],
        ...
        "ب": {
            ...
            "examples_from_basil": ['بحر/نهر: نقطة الباء السفلية توحي بقطرة ماء انصبت.', 'طلب، حلب، سلب، نهب: فيها معنى الانتقال.', 'بلع، بلغ، بعد، قرب: تفيد الانتقال والتشبع.', \"اسم الحرف 'باء' من باء يبوء (امتلأ به وبان عليه).\"],
        ...
        "ت": {
            ...
            "examples_from_basil": ['تم، تمام، أتم: تفيد الإتمام والاكتمال', 'تاب، توب: تفيد الرجوع والعودة إلى الأصل'],
        ...
        "ث": {
            ...
            "examples_from_basil": ['ثر، ثرى، ثروة: تفيد الكثرة والانتشار', 'بث، نفث: تفيد النشر والتفريق'],
        ...
        "ج": {
            ...
            "examples_from_basil": ['جمع، جماعة: تفيد التجمع والاجتماع', 'جوف، جيب: تفيد التجويف والاحتواء', 'جبل: تجمع الصخور والتراب في مكان مرتفع'],
        ...
        "ح": {
            ...
            "examples_from_basil": ['حي، حياة: تفيد الحياة والحيوية', 'حوط، حاط: تفيد الإحاطة والحماية', 'حد، حدود: تفيد التحديد والفصل'],
        ...
        "خ": {
            ...
            "examples_from_basil": ['خرج، خروج: تفيد الخروج والانفصال', 'خرق، اختراق: تفيد النفاذ والاختراق', 'خلا، خلاء: تفيد الفراغ والخلو'],
        ...
        "د": {
            ...
            "examples_from_basil": ['دخل، دخول: تفيد الدخول والولوج', 'درب، درج: تفيد المسار والطريق', 'دار: تفيد المكان المحيط والمغلق'],
        ...
        "ذ": {
            ...
            "examples_from_basil": ['ذكر، تذكير: تفيد الذكر والتذكير', 'ذاب، ذوبان: تفيد الانتشار والتلاشي اللطيف', 'ذهب: تفيد الانتقال والمضي'],
        ...
        "ر": {
            ...
            "examples_from_basil": ['كرر، تكرار: تفيد التكرار والإعادة', 'دار، دوران: تفيد الحركة الدائرية', 'جرى، جريان: تفيد الحركة المستمرة'],
        ...
        "ز": {
            ...
            "examples_from_basil": ['زاد، زيادة: تفيد النمو والزيادة', 'زحف، انزلاق: تفيد الحركة الانسيابية', 'زمن، زمان: تفيد الاستمرارية والتقدم'],
        ...
        "س": {
            ...
            "examples_from_basil": ['سال، سيل: تفيد الانسياب والجريان', 'سار، مسير: تفيد الحركة المستمرة', 'سلس، سلاسة: تفيد السهولة والانسيابية'],
        ...
        "ش": {
            ...
            "examples_from_basil": ['شجرة: تفيد التفرع والانتشار', 'شع، إشعاع: تفيد الانتشار من مركز', 'شرح، شرح: تفيد التوسع والتفصيل'],
        ...
        "ص": {
            ...
            "examples_from_basil": ['صلب، صلابة: تفيد القوة والمتانة', 'صفا، صفاء: تفيد النقاء والخلوص', 'صان، صيانة: تفيد الحفظ والحماية'],
        ...
        "ض": {
            ...
            "examples_from_basil": ['ضغط، ضاغط: تفيد الضغط والقوة', 'ضرب، ضارب: تفيد التأثير القوي', 'ضرورة، اضطرار: تفيد الإلزام والحتمية'],
        ...
        "ط": {
            ...
            "examples_from_basil": ['طال، طويل: تفيد الامتداد والطول', 'طاف، طواف: تفيد الدوران والإحاطة', 'طبق، إطباق: تفيد الشمول والتغطية'],
        ...
        "ظ": {
            ...
            "examples_from_basil": ['ظهر، ظهور: تفيد البروز والوضوح', 'ظل، ظلال: تفيد الانعكاس والتجلي', 'ظن، ظنون: تفيد التصور والتخيل'],
        ...
        "ع": {
            ...
            "examples_from_basil": ['علم، معرفة: تفيد الإدراك والفهم', 'عمق، عميق: تفيد البعد والغور', 'عم، عموم: تفيد الشمول والاتساع'],
        ...
        "غ": {
            ...
            "examples_from_basil": ['غطى، تغطية: تفيد الستر والإخفاء', 'غاب، غياب: تفيد الاختفاء والبعد', 'غمض، غموض: تفيد الإبهام وعدم الوضوح'],
        ...
        "ف": {
            ...
            "examples_from_basil": ['فتح، فاتح: تفيد الفتح والكشف', 'فصل، فاصل: تفيد القطع والتمييز', 'فرغ، فراغ: تفيد الخلو والسعة'],
        ...
        "ق": {
            ...
            "examples_from_basil": ['قطع، قاطع: تفيد الفصل الحاسم', 'قوي، قوة: تفيد الشدة والمتانة', 'قام، قيام: تفيد الثبات والاستقرار'],
        ...
        "ك": {
            ...
            "examples_from_basil": ['كبت، كاتم: تفيد الحبس والمنع', 'كف، كفاف: تفيد الإمساك والاحتواء', 'كأن، مثل: تفيد التشبيه والمماثلة'],
        ...
        "ل": {
            ...
            "examples_from_basil": ['لصق، التصاق: تفيد الارتباط والقرب', 'له، لي: تفيد الملكية والاختصاص', 'لأجل، لكي: تفيد التعليل والغاية'],
        ...
        "م": {
            ...
            "examples_from_basil": ['تم، تمام: تفيد الاكتمال والنهاية', 'جمع، مجموع: تفيد الضم والتجميع', 'ملأ، امتلاء: تفيد الشغل والتعبئة'],
        ...
        "ن": {
            ...
            "examples_from_basil": ['نبت، نمو: تفيد الظهور والزيادة', 'نور، إنارة: تفيد الإضاءة والوضوح', 'نون: اسم الحرف يرتبط بالحوت والماء والحياة'],
        ...
        "ه": {
            ...
            "examples_from_basil": ['هواء، تهوية: تفيد الخفة والفراغ', 'هدأ، هدوء: تفيد السكون والراحة', 'هاء: اسم الحرف يرتبط بالتنفس والحياة'],
        ...
        "و": {
            ...
            "examples_from_basil": ['وصل، واصل: تفيد الربط والاتصال', 'ودام، دوام: تفيد الاستمرار والبقاء', 'وجمع، مجموع: تفيد الضم والتجميع'],
        ...
        "ي": {
            ...
            "examples_from_basil": ['يد، أيدي: تفيد الامتداد والقدرة', 'لي، إليّ: تفيد الملكية والنسبة', 'يمن، يمين: تفيد القوة والبركة'],
        ...
        "ء": {
            ...
            "examples_from_basil": ['سأل، مسألة: تفيد الاستفهام والمفاجأة', 'بدأ، ابتداء: تفيد البدء والشروع', 'قرأ، قراءة: تفيد النطق والتلفظ'],
        ...
        "ة": {
            ...
            "examples_from_basil": ['معلمة، طالبة: تفيد التأنيث والتخصيص', 'حديقة، غرفة: تفيد الاحتواء والإحاطة', 'نهاية، خاتمة: تفيد الاكتمال والختام'],
